...
-- ALTERAR ALGUMA INFORMAÇÃO DO ADMINISTRADOR.

delimiter $$
create procedure alterar_informação_do_administrador( cod int, nome_adm varchar(50),email_adm varchar(30),senha_adm varchar(20))
begin
...
-- EXCLUIR O ADMINSTRADOR REGISTRADO.
...
-- ALTERAR ALGUMA INFORMAÇÃO DO USUARIO.


delimiter $$
create procedure alterar_informação_do_usuario( cod int, nome_usuario varchar(50),email_usuario varchar(30),senha_usuario varchar(20),status_usuario varchar(15))
begin
...
-- EXCLUIR A OCORRENCIA REGISTRADA.
